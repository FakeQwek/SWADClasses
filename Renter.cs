...
public class Renter : User
{
    ...
    public Renter(int id, string fullName, string email, DateTime dateOfBirth, List<DateTime> driversLicenseInfo, List<Booking> bookingList) : base(id, fullName, email)
    {
